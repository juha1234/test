                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="../product_board/product-detail.jsp"><img src="../img/man/polo-shirt-2.png" alt="polo shirt img"></a>
                              <figcaption>
                          ...
                          <div class="aa-product-hvr-content">
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a> <!--  찜하기 버튼 -->
